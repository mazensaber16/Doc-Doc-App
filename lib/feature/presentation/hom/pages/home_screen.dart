...
class HomeScreen extends StatelessWidget {
  ...
  final List<Map<String, String>> doctorSpecialities = [
    {"name": "Children", "image": AssetsManager.childrenImage},
    {"name": "Brain", "image": AssetsManager.brainImage},
    {"name": "Pediatric", "image": AssetsManager.pediatricImage},
    {"name": "Radiology", "image": AssetsManager.radiologyImage},
  ];
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    CustomIcon(
                      image: Icon(Icons.notifications, color: AppColors.secondGreyColor, size: 33.sp),
                    ),
                  ],
                ),
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemCount: doctorSpecialities.length,
