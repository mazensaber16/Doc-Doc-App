...
import 'package:doc_doc/feature/presentation/appointment/pages/summary_screen.dart';
...
import 'feature/presentation/appointment/pages/appointment_provider.dart';
import 'feature/presentation/appointment/pages/payment_screen.dart';
        ...
        builder: (context, child){
          return MaterialApp(
            ...
            routes: {
              ...
              AppRoutes.paymentRoute:(context)=>PaymentScreen(),
              AppRoutes.summaryRoute:(context)=>SummaryScreen(),
